...
//			createAdditionalInstructors(instructorDAO);
	...
	private void createAdditionalInstructors(InstructorDAO instructorDAO)
	{
		...
		instructor1.setInstructorDetailId(instructorDetail);
		...
		instructor2.setInstructorDetailId(instructorDetail);
	...
	private void createInstructor(InstructorDAO instructorDAO)
	{
		...
		instructor3.setInstructorDetailId(instructorDetail);
